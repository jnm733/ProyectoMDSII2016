...
public class PuntoInteresDAO {
	...
	public static PuntoInteres loadPuntoInteresByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (PuntoInteres) session.load(diagrama_de_base_de_datos.PuntoInteres.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static PuntoInteres getPuntoInteresByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (PuntoInteres) session.get(diagrama_de_base_de_datos.PuntoInteres.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static PuntoInteres loadPuntoInteresByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (PuntoInteres) session.load(diagrama_de_base_de_datos.PuntoInteres.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static PuntoInteres getPuntoInteresByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (PuntoInteres) session.get(diagrama_de_base_de_datos.PuntoInteres.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static PuntoInteres createPuntoInteres() {
		return new diagrama_de_base_de_datos.PuntoInteres();
	}
	
	public static boolean save(diagrama_de_base_de_datos.PuntoInteres puntoInteres) throws PersistentException {
		try {
			diagrama_de_base_de_datos.ProyectoMDS2PersistentManager.instance().saveObject(puntoInteres);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(diagrama_de_base_de_datos.PuntoInteres puntoInteres) throws PersistentException {
		try {
			diagrama_de_base_de_datos.ProyectoMDS2PersistentManager.instance().deleteObject(puntoInteres);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(diagrama_de_base_de_datos.PuntoInteres puntoInteres)throws PersistentException {
		try {
			diagrama_de_base_de_datos.Parada[] lContienes = puntoInteres.contiene.toArray();
	...
	public static boolean deleteAndDissociate(diagrama_de_base_de_datos.PuntoInteres puntoInteres, org.orm.PersistentSession session)throws PersistentException {
		try {
			diagrama_de_base_de_datos.Parada[] lContienes = puntoInteres.contiene.toArray();
			for(int i = 0; i < lContienes.length; i++) {
				lContienes[i].pertenece.remove(puntoInteres);
	...
	public static boolean refresh(diagrama_de_base_de_datos.PuntoInteres puntoInteres) throws PersistentException {
		try {
			diagrama_de_base_de_datos.ProyectoMDS2PersistentManager.instance().getSession().refresh(puntoInteres);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(diagrama_de_base_de_datos.PuntoInteres puntoInteres) throws PersistentException {
		try {
			diagrama_de_base_de_datos.ProyectoMDS2PersistentManager.instance().getSession().evict(puntoInteres);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
