...
public class DireccionDAO {
	...
	public static Direccion loadDireccionByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Direccion) session.load(diagrama_de_base_de_datos.Direccion.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Direccion getDireccionByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Direccion) session.get(diagrama_de_base_de_datos.Direccion.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Direccion loadDireccionByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Direccion) session.load(diagrama_de_base_de_datos.Direccion.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Direccion getDireccionByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Direccion) session.get(diagrama_de_base_de_datos.Direccion.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Direccion createDireccion() {
		return new diagrama_de_base_de_datos.Direccion();
	}
	
	public static boolean save(diagrama_de_base_de_datos.Direccion direccion) throws PersistentException {
		try {
			diagrama_de_base_de_datos.ProyectoMDS2PersistentManager.instance().saveObject(direccion);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(diagrama_de_base_de_datos.Direccion direccion) throws PersistentException {
		try {
			diagrama_de_base_de_datos.ProyectoMDS2PersistentManager.instance().deleteObject(direccion);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(diagrama_de_base_de_datos.Direccion direccion)throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(diagrama_de_base_de_datos.Direccion direccion, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (direccion.getPto_se_ubica() != null) {
				direccion.getPto_se_ubica().setTiene(null);
			}
	...
	public static boolean refresh(diagrama_de_base_de_datos.Direccion direccion) throws PersistentException {
		try {
			diagrama_de_base_de_datos.ProyectoMDS2PersistentManager.instance().getSession().refresh(direccion);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(diagrama_de_base_de_datos.Direccion direccion) throws PersistentException {
		try {
			diagrama_de_base_de_datos.ProyectoMDS2PersistentManager.instance().getSession().evict(direccion);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
