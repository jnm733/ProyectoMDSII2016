...
public class ImagenDAO {
	...
	public static Imagen loadImagenByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Imagen) session.load(diagrama_de_base_de_datos.Imagen.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Imagen getImagenByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Imagen) session.get(diagrama_de_base_de_datos.Imagen.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Imagen loadImagenByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Imagen) session.load(diagrama_de_base_de_datos.Imagen.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Imagen getImagenByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Imagen) session.get(diagrama_de_base_de_datos.Imagen.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Imagen createImagen() {
		return new diagrama_de_base_de_datos.Imagen();
	}
	
	public static boolean save(diagrama_de_base_de_datos.Imagen imagen) throws PersistentException {
		try {
			diagrama_de_base_de_datos.ProyectoMDS2PersistentManager.instance().saveObject(imagen);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(diagrama_de_base_de_datos.Imagen imagen) throws PersistentException {
		try {
			diagrama_de_base_de_datos.ProyectoMDS2PersistentManager.instance().deleteObject(imagen);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(diagrama_de_base_de_datos.Imagen imagen)throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(diagrama_de_base_de_datos.Imagen imagen, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (imagen.getContiene() != null) {
				imagen.getContiene().setImagen_pertenece(null);
			}
	...
	public static boolean refresh(diagrama_de_base_de_datos.Imagen imagen) throws PersistentException {
		try {
			diagrama_de_base_de_datos.ProyectoMDS2PersistentManager.instance().getSession().refresh(imagen);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(diagrama_de_base_de_datos.Imagen imagen) throws PersistentException {
		try {
			diagrama_de_base_de_datos.ProyectoMDS2PersistentManager.instance().getSession().evict(imagen);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
