...
public class ConsultaDAO {
	...
	public static boolean deleteAndDissociate(diagrama_de_base_de_datos.Consulta consulta)throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(diagrama_de_base_de_datos.Consulta consulta, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (consulta.getRealiza() != null) {
				consulta.getRealiza().realizada_por.remove(consulta);
			}
