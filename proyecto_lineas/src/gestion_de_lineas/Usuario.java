...
public class Usuario implements Serializable {
	...
	private java.util.Set this_getSet (int key) {
		if (key == gestion_de_lineas.ORMConstants.KEY_USUARIO_REALIZADA_POR) {
	...
	public final gestion_de_lineas.ConsultaSetCollection realizada_por = new gestion_de_lineas.ConsultaSetCollection(this, _ormAdapter, gestion_de_lineas.ORMConstants.KEY_USUARIO_REALIZADA_POR, gestion_de_lineas.ORMConstants.KEY_CONSULTA_REALIZA, gestion_de_lineas.ORMConstants.KEY_MUL_ONE_TO_MANY);
