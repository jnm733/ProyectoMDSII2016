...
public class UsuarioDetachedCriteria extends AbstractORMDetachedCriteria {
	...
	public UsuarioDetachedCriteria() {
		super(gestion_de_lineas.Usuario.class, gestion_de_lineas.UsuarioCriteria.class);
	...
	public UsuarioDetachedCriteria(DetachedCriteria aDetachedCriteria) {
		super(aDetachedCriteria, gestion_de_lineas.UsuarioCriteria.class);
		ID = new IntegerExpression("ID", this.getDetachedCriteria());
		nombre = new StringExpression("nombre", this.getDetachedCriteria());
		password = new StringExpression("password", this.getDetachedCriteria());
		email = new StringExpression("email", this.getDetachedCriteria());
	...
	public gestion_de_lineas.ConsultaDetachedCriteria createRealizada_porCriteria() {
		return new gestion_de_lineas.ConsultaDetachedCriteria(createCriteria("ORM_Realizada_por"));
	}
