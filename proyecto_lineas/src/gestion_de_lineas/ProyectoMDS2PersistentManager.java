...
public class ProyectoMDS2PersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "ProyectoMDS2";
	...
	private ProyectoMDS2PersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new ProyectoMDS2PersistentManager();
		}
