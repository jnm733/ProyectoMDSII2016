...
public class EventoDAO {
	...
	public static Evento loadEventoByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Evento) session.load(gestion_de_lineas.Evento.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Evento getEventoByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Evento) session.get(gestion_de_lineas.Evento.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Evento loadEventoByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Evento) session.load(gestion_de_lineas.Evento.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Evento getEventoByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Evento) session.get(gestion_de_lineas.Evento.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Evento createEvento() {
		return new gestion_de_lineas.Evento();
	}
	
	public static boolean save(gestion_de_lineas.Evento evento) throws PersistentException {
		try {
			gestion_de_lineas.ProyectoMDS2PersistentManager.instance().saveObject(evento);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(gestion_de_lineas.Evento evento) throws PersistentException {
		try {
			gestion_de_lineas.ProyectoMDS2PersistentManager.instance().deleteObject(evento);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(gestion_de_lineas.Evento evento)throws PersistentException {
		try {
			gestion_de_lineas.Parada[] lContienes = evento.contiene.toArray();
	...
	public static boolean deleteAndDissociate(gestion_de_lineas.Evento evento, org.orm.PersistentSession session)throws PersistentException {
		try {
			gestion_de_lineas.Parada[] lContienes = evento.contiene.toArray();
			for(int i = 0; i < lContienes.length; i++) {
				lContienes[i].evento_pertenece.remove(evento);
	...
	public static boolean refresh(gestion_de_lineas.Evento evento) throws PersistentException {
		try {
			gestion_de_lineas.ProyectoMDS2PersistentManager.instance().getSession().refresh(evento);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(gestion_de_lineas.Evento evento) throws PersistentException {
		try {
			gestion_de_lineas.ProyectoMDS2PersistentManager.instance().getSession().evict(evento);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
