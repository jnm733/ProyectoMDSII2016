...
public class EventosAdmin extends JPanel {
	...
	public EventosAdmin() {
		...
		sl_panel_4.putConstraint(SpringLayout.SOUTH, btnEvento, 0, SpringLayout.SOUTH, btnVincularParadas);
		sl_panel_4.putConstraint(SpringLayout.EAST, btnEvento, -10, SpringLayout.EAST, panel_4);
		...
		sl_panel.putConstraint(SpringLayout.WEST, lblEventos, 0, SpringLayout.WEST, listEventos);
		sl_panel.putConstraint(SpringLayout.SOUTH, lblEventos, -6, SpringLayout.NORTH, listEventos);
		sl_panel.putConstraint(SpringLayout.NORTH, listEventos, 35, SpringLayout.NORTH, panel);
		sl_panel.putConstraint(SpringLayout.WEST, listEventos, 10, SpringLayout.WEST, panel);
		sl_panel.putConstraint(SpringLayout.EAST, listEventos, -309, SpringLayout.EAST, panel);
		...
		btnEliminarEvento.setEnabled(false);
		sl_panel.putConstraint(SpringLayout.SOUTH, listEventos, -6, SpringLayout.NORTH, btnEliminarEvento);
		sl_panel.putConstraint(SpringLayout.WEST, btnEliminarEvento, 10, SpringLayout.WEST, panel);
		sl_panel.putConstraint(SpringLayout.SOUTH, btnEliminarEvento, -10, SpringLayout.SOUTH, panel);
		panel.add(btnEliminarEvento);

		// Nombre

		JLabel lblNombre = new JLabel("Nombre");
		sl_panel.putConstraint(SpringLayout.NORTH, lblNombre, 36, SpringLayout.NORTH, panel);
		sl_panel.putConstraint(SpringLayout.WEST, lblNombre, 36, SpringLayout.EAST, listEventos);
		panel.add(lblNombre);

		txtNombre = new JTextField();
		sl_panel.putConstraint(SpringLayout.NORTH, txtNombre, 36, SpringLayout.NORTH, panel);
		txtNombre.setText("Nombre");
		...
		sl_panel.putConstraint(SpringLayout.NORTH, lblDireccion, 39, SpringLayout.SOUTH, lblNombre);
		sl_panel.putConstraint(SpringLayout.WEST, lblDireccion, 0, SpringLayout.WEST, lblNombre);
		panel.add(lblDireccion);

		txtDireccion = new JTextField();
		txtDireccion.setText("Direccion");
		sl_panel.putConstraint(SpringLayout.NORTH, txtDireccion, 0, SpringLayout.NORTH, lblDireccion);
		...
		sl_panel.putConstraint(SpringLayout.NORTH, lblNewLabel, 0, SpringLayout.NORTH, lblEventos);
		sl_panel.putConstraint(SpringLayout.WEST, lblNewLabel, 82, SpringLayout.EAST, lblEventos);
		panel.add(lblNewLabel);

		// Fecha de inicio

		JLabel lblFechaInicio = new JLabel("Fecha Inicio");
		sl_panel.putConstraint(SpringLayout.WEST, lblFechaInicio, 0, SpringLayout.WEST, lblNombre);
		panel.add(lblFechaInicio);

		txtFechaInicio = new JTextField();
		sl_panel.putConstraint(SpringLayout.NORTH, txtFechaInicio, -3, SpringLayout.NORTH, lblFechaInicio);
		sl_panel.putConstraint(SpringLayout.EAST, txtFechaInicio, 0, SpringLayout.EAST, txtNombre);
		txtFechaInicio.setText("Fecha Inicio");
		...
		sl_panel.putConstraint(SpringLayout.WEST, txtParadaCercana, 0, SpringLayout.WEST, txtNombre);
		txtParadaCercana.setText("Parada Cercana");
		panel.add(txtParadaCercana);
		txtParadaCercana.setColumns(10);

		lblParada = new JLabel("Parada");
		sl_panel.putConstraint(SpringLayout.NORTH, lblFechaInicio, 40, SpringLayout.SOUTH, lblParada);
		sl_panel.putConstraint(SpringLayout.NORTH, txtParadaCercana, -3, SpringLayout.NORTH, lblParada);
		sl_panel.putConstraint(SpringLayout.NORTH, lblParada, 35, SpringLayout.SOUTH, lblDireccion);
		sl_panel.putConstraint(SpringLayout.WEST, lblParada, 0, SpringLayout.WEST, lblNombre);
		panel.add(lblParada);
		...
		btnEvento.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				boolean ok = true;
				if (txtNombre.getText().equals("Nombre")) {
					JOptionPane.showMessageDialog(null, "Introduzca el nombre del evento", "Error",
							JOptionPane.ERROR_MESSAGE);
				} else if (txtDireccion.getText().equals("Direccion")) {
					JOptionPane.showMessageDialog(null, "Introduzca la direccion del evento", "Error",
							JOptionPane.ERROR_MESSAGE);
				} else if (txtParadaCercana.getText().equals("Parada cercana")) {
					JOptionPane.showMessageDialog(null, "Introduzca una parada de referencia para el evento", "Error",
							JOptionPane.ERROR_MESSAGE);
				} else if (txtFechaInicio.getText().equals("Fecha Inicio")) {
					JOptionPane.showMessageDialog(null,
							"Introduzca una fecha de inicio para el evento. Formato dd/mm/aa", "Error",
							JOptionPane.ERROR_MESSAGE);
				} else if (txtFechaFin.getText().equals("Fecha Fin")) {
					JOptionPane.showMessageDialog(null, "Introduzca una fecha de fin para el evento. Formato dd/mm/aa",
							"Error", JOptionPane.ERROR_MESSAGE);
				} else {
					StringTokenizer tokenInicio = new StringTokenizer(txtFechaInicio.getText(), "/");
					if (tokenInicio.countTokens() != 3) {
						ok = false;
						JOptionPane.showMessageDialog(null, "Formato inválido en fecha inicio. Formato dd/mm/aa",
								"Error", JOptionPane.ERROR_MESSAGE);
					} else {
						while (tokenInicio.hasMoreTokens()) {
							try {
								...
								ok = false;
								JOptionPane.showMessageDialog(null,
										"Formato inválido en fecha inicio. Formato dd/mm/aa", "Error",
										JOptionPane.ERROR_MESSAGE);
							}
						}
					}
					...
					if (tokenFin.countTokens() != 3) {
						ok = false;
						JOptionPane.showMessageDialog(null, "Formato inválido en fecha fin. Formato dd/mm/aa", "Error",
								JOptionPane.ERROR_MESSAGE);
					} else {
						while (tokenFin.hasMoreTokens()) {
							try {
								...
								ok = false;
								JOptionPane.showMessageDialog(null, "Formato inválido en fecha fin. Formato dd/mm/aa",
										"Error", JOptionPane.ERROR_MESSAGE);
							}
						}
					}
					if (ok) {
						...
						if (!existeEvento()) {
							incluirEvento();
							JOptionPane.showMessageDialog(null, "Evento incluido con éxito", "Exito",
		...
		btnVincularParadas.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				vincularEventos vincular = new vincularEventos(txtNombre.getText(), listParadas);
	...
	private boolean existeEvento() {
		...
		eventos = bd_principal.getEventos();
		for (int i = 0; i < eventos.length; i++) {
			if (eventos[i].getNombreEvento().equals(txtNombre.getText())) {
				existe = true;
				break;
			}
		}
